	...
	return (
		<div class='projects'>
			...
			<div className='project'>
				<h3>Chess</h3>
				<h5>Technologies: </h5> <p>JavaScript, NodeJS, Socket.io</p>
				<p>
			...
			<div className='project'>
				...
				<p>
					I combined my passion with Magic The Gathering and Programming and
					built a Magic The Gathering deck builder site. Users can build their
					own deck and save their decks locally.
				</p>
				<h5>Deployed App: </h5>
