	...
	<div id='about'>
		...
		<div className='about-container'>
			...
			<h4 className='about-text'>
				...
				to develop a deeper understanding on how and why it works. I'm looking
				for a company that will utilize my strong-problem solving, analytical,
				and creative thinking skill-set.
			</h4>
		</div>
	</div>
)
